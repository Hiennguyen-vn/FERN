    ...
    <div className="space-y-5">
      ...
      <div className="flex items-start gap-2.5 p-3 rounded-md bg-info/5 border border-info/10">
        ...
        <p className="text-[11px] text-info leading-relaxed">
          User creation requires the IAM service to be available. While iam-service is branch-blocked, this form captures the target-state UX. 
          The account will be provisioned via <code className="text-[10px] bg-muted px-1 rounded">POST /api/iam/users</code> once the migration is resolved.
        </p>
      </div>
    </div>
  );
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-start gap-2.5 p-3 rounded-md bg-info/5 border border-info/10">
        ...
        <p className="text-[11px] text-info leading-relaxed">
          ...
          Changes will be submitted via <code className="text-[10px] bg-muted px-1 rounded">PUT /api/iam/users/{'{userId}'}</code> once migration V19 is resolved.
        </p>
      </div>
    </div>
  );
