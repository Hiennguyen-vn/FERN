...
public class StockCountService {
    ...
    public StockCountSessionResponse postStockCountSession(FernPrincipal principal, Long id, String idempotencyKey) {
        ...
        for (StockCountLineRecord line : lines) {
            ...
            BigDecimal unitCost = inventoryRepository.currentUnitCost(record.outletId(), line.ingredientId());
    ...
    private void enqueueStockCountPosted(StockCountSessionRecord record, FernPrincipal principal, List<StockCountLineRecord> lines) {
        ...
        enqueueOutbox("STOCK_COUNT_SESSION", record.id().toString(), event.eventType(), record.outletId().toString(), event);
    }
