...
final class FinanceJdbcSupport {
    private FinanceJdbcSupport() {
    }

    static Long insertForId(NamedParameterJdbcTemplate template, String sql, MapSqlParameterSource parameters) {
    ...
    static Long nullableLong(ResultSet rs, String column) throws java.sql.SQLException {
