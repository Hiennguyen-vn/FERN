    ...
    private boolean jsonEquals(String left, String right) {
        try {
            ...
            if (leftNode.isObject()) {
                ...
                ((com.fasterxml.jackson.databind.node.ObjectNode) leftNode).remove("eventId");
                ((com.fasterxml.jackson.databind.node.ObjectNode) leftNode).remove("correlationId");
            }
            if (rightNode.isObject()) {
                rightNode = rightNode.deepCopy();
                ((com.fasterxml.jackson.databind.node.ObjectNode) rightNode).remove("eventId");
                ((com.fasterxml.jackson.databind.node.ObjectNode) rightNode).remove("correlationId");
            }
