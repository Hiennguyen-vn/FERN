...
public class FinanceOutboxPublisher {
    ...
    public FinanceOutboxPublisher(NamedParameterJdbcTemplate jdbcTemplate, KafkaTemplate<String, String> kafkaTemplate, Clock clock) {
    ...
    public void publishPending() {
        ...
        for (PendingEvent event : events) {
            try {
                ...
                log.warn(
                        "finance_outbox_publish_failed eventId={} eventType={} reason={}",
                        event.id(),
                        event.eventType(),
