...
class ProcurementOutboxPublisherTest {
    ...
    void shouldKeepPublishingRemainingEventsWhenAlertPublishingFails() {
        JdbcOutboxPublisherSupport.ClaimedOutboxEvent failedEvent = claimedEvent(2, "9901");
        JdbcOutboxPublisherSupport.ClaimedOutboxEvent nextEvent = claimedEvent(0, "9902");
