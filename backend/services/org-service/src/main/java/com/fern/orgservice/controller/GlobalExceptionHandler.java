...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ForbiddenException.class, JwtException.class})
    ResponseEntity<ApiErrorResponse> handleForbidden(RuntimeException exception, HttpServletRequest request) {
    ...
    ResponseEntity<ApiErrorResponse> handleOther(Exception exception, HttpServletRequest request) {
        log.error(
                "org_unhandled_exception correlationId={} path={} exceptionType={}",
