...
public class RefreshTokenService {
    ...
    @Transactional
    public String issue(Long userId, IamRequestMetadata requestMetadata) {
        ...
        entity.setIpAddress(effectiveRequestMetadata.ipAddress());
        entity.setUserAgent(effectiveRequestMetadata.userAgent());
    ...
    @Transactional
    public String rotate(String existingToken, Long userId, IamRequestMetadata requestMetadata) {
        revoke(existingToken);
        return issue(userId, requestMetadata);
    }
