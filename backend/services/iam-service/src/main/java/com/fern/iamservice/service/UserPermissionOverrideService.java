...
public class UserPermissionOverrideService {
    ...
    @Transactional
    public UserPermissionOverridesResponse replace(
            FernPrincipal principal,
            Long userId,
            PutUserPermissionOverridesRequest request,
        ...
        iamAuditService.permissionOverridesChanged(principal, userId, response, requestMetadata);
        return response;
    }
