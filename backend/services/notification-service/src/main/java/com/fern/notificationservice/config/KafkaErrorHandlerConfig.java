 ...
 *   <li>Deserialization and validation errors skip retries (not-retryable) and go directly to DLQ</li>
 * </ul>
 *
 * <p>This prevents poisoned messages from blocking the consumer group while
 * preserving failed events for investigation and replay.
 */
@Configuration
