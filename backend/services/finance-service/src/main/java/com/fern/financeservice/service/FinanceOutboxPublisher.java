    ...
    public void publishPending() {
        ...
        for (JdbcOutboxPublisherSupport.ClaimedOutboxEvent event : events) {
            try {
                ...
                JdbcOutboxPublisherSupport.markPublished(jdbcTemplate, "finance.outbox_event", event.id(), clock.instant());
                ...
                if (outcome.terminalFailure()) {
                    ...
                    try {
                        ...
                        log.error(
                                "finance_outbox_terminal_alert_failed eventId={} eventType={} reason={}",
                                event.id(),
                                event.eventType(),
