        ...
        <div className="flex items-start gap-3 px-4 py-3 rounded-lg bg-destructive/5 border border-destructive/15">
          ...
          <div>
            ...
            <p className="text-[11px] text-muted-foreground mt-0.5">
              {unpublished.map(p => p.code).join(', ')} are defined in PermissionCodes but not yet bootstrapped into the IAM database. 
              No roles can reference these codes until migration V19 is resolved.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="flex items-start gap-2.5 p-3 rounded-md bg-warning/5 border border-warning/10">
        ...
        <div>
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5 leading-relaxed">
            ...
            No role can reference or assign these codes. This will resolve when migration V19 completes successfully and iam-service restarts.
          </p>
        </div>
      </div>
    </div>
